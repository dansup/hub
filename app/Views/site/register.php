<?php $this->layout('base::template', ['title' => 'Register a user account']); ?>
    ...
    <div class="col-xs-12 col-md-8 col-md-offset-2">
      ...
      <div class="form-group well well-sm">
        ...
        <div class="col-sm-10">
          ...
          <span id="<?= $form_names['username'] ?>-helpBlock" class="help-block">Your desired username, must be unique.</span>
        </div>
      </div>
      <div class="form-group well well-sm">
