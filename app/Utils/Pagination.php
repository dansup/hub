    ...
    */
    ...
    protected function build_links_first_prev()
    {
        ...
        if($this->options['show_links_first_last'] == true)
        {
            ...
            {
                $this->links_html .= '<li class="'.$this->options['class_dead_links'].'">'.$this->options['text_first'].'</li>'.PHP_EOL;
            }
    ...
    protected function loop_through_links($start, $finish, $array_block_label = '')
    {
        ...
        while($counter <= $finish)
        {
            ...
            {
                $this->links_html .= '<li class="'.$this->get_current_or_normal_class($counter).'"><a href="#">'.$counter.'</a></li>'.PHP_EOL;
            }
            else
            {
