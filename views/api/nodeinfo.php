...
$get_ip = filter_var($_REQUEST['ip'], FILTER_VALIDATE_IP, FILTER_FLAG_IPV6);
...
header('Location: /api/0/nodeinfo/'.$get_ip.'.json');
exit;
}
...
$resp = json_encode(['response'=>false,'response_code'=>404,'error_msg'=>'Node not found in our database.'], JSON_PRETTY_PRINT);
return $resp;
}
