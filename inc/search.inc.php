...
{  
	...
	echo '    <div class="col-xs-12 col-md-8 col-md-offset-2 well search-result"><a href="'.$ip_url.'"><p class="lead">'.$row['addr'].$hostname.'</p></a><hr><span class="search-result-hostname"><span class="label label-default"><?=$latency?> ms</span>&nbsp;<span class="label label-default">Protocol: <?=$protocol?></span></span><span class="search-result-lastseen">last seen: <time class="timeago" datetime="'.$last_seen.'"></time></span></div>';  
}  
