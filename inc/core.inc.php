    ...
    public function get($ip)
    {
        ...
        public function inbox($uid)
        {
            ...
            */
            ...
            if(is_null($messageArray) or !$messageArray) { return false; }
...
class Router
{
    ...
    public function stripFunnyAddy($ipath)
    {
        ...
        if($ipath_len !== 59) {
            $this->errorMessage = "Invalid length"; return false;
        }
...
class Nmapper {
    ...
    public function newScan($addr)
    {
        ...
        if ($r = false OR $r = null) { return false; }
...
class Blog {
    ...
    public function newBlogPost($title, $url, $tags, $body, $uid, $snippet = false, $ts = false)
    {
        ...
        if(!$stmt->execute()) {
            throw new Exception('Error in insert.'); return false;
        }
        return true;
    }
}
